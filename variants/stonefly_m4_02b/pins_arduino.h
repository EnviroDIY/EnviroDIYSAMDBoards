...
#define STONEFLY_M4_02B_VERSION_MAJOR 0
/** Board minor version number (x.X.x) */
#define STONEFLY_M4_02B_VERSION_MINOR 2
/** Board patch version number (x.x.X) */
#define STONEFLY_M4_02B_VERSION_PATCH 2

/**
 * Macro to convert version number into an integer
 *
 * To be used in comparisons, such as STONEFLY_M4_02B_VERSION >= STONEFLY_M4_02B_VERSION_VAL(4, 0, 0)
 */
#define ENVIRODIY_SAMD_BOARDS_VERSION_VAL(major, minor, patch)((major << 16) | (minor << 8) | (patch))
#define STONEFLY_M4_02B_VERSION_VAL(major, minor, patch)((major << 16) | (minor << 8) | (patch))
...
#define STONEFLY_M4_02B_VERSION STONEFLY_M4_02B_VERSION_VAL(STONEFLY_M4_02B_VERSION_MAJOR, STONEFLY_M4_02B_VERSION_MINOR, STONEFLY_M4_02B_VERSION_PATCH)
// clang-format on
